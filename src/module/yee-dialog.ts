...
export class YeeDialog {

    public static readyFunc = [];

    public static open(url: string, title: string = '网页对话框', setting: { [p: string]: any } = {}, callWindow = window, elem = null) {
    ...
    public constructor(elem = null) {
        ...
        qel.on('click', function (ev) {
            ...
            let setting = Yee.getElemData(qel, 'Dialog');
